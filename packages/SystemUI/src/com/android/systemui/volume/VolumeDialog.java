...
public class VolumeDialog {
    ...
    private void updateVolumeRowH(VolumeRow row) {
        ...
        final boolean isRingOrNotificationSilent = isRingOrNotificationStream
        ...
        final int iconRes =
                (isRingStream && !linkNotificationWithVolume) ?
                        isRingSilent ? R.drawable.ic_ringer_new_mute
                        : isRingVibrate ? R.drawable.ic_volume_ringer_vibrate
                        : R.drawable.ic_ringer_new_audible
                : isRingVibrate ? R.drawable.ic_volume_ringer_vibrate
                : isRingOrNotificationSilent ? R.drawable.ic_volume_ringer_mute
        ...
        // update slider
        final boolean enableSlider = isNotificationStream ? (!zenMuted && !isRingVibrate && !isRingOrNotificationSilent) : !zenMuted;
        final int vlevel = row.ss.muted && (isRingOrNotificationSilent || isRingVibrate || !isRingOrNotificationStream && !zenMuted) ? 0
                : row.ss.level;
