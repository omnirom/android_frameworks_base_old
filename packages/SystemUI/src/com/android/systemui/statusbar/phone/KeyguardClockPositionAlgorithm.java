...
public class KeyguardClockPositionAlgorithm {
    ...
    private int getClockY() {
        ...
        Log.d("maxwen", "clockY = " + clockY + " mKeyguardStatusHeight = " + mKeyguardStatusHeight + " burnInPreventionOffsetY() = " + burnInPreventionOffsetY());
        return clockY;
    }
    ...
    private int getAmbientContainerY() {
        ...
        Log.d("maxwen", "ambientContainerY = " + ambientContainerY + " mAmbientContainerHeight = " + mAmbientContainerHeight);
