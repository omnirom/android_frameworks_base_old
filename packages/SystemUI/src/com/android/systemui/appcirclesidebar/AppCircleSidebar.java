...
public class AppCircleSidebar extends FrameLayout implements PackageAdapter.OnCircleItemClickListener,
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.BLACKLIST_APP_CIRCLE_BAR), false, this);
            update();
        }
        ...
        public void update() {
            final ContentResolver resolver = mContext.getContentResolver();
            setAppBarVisibility(Settings.System.getInt(
                    resolver, Settings.System.ENABLE_APP_CIRCLE_BAR, 0) == 1);
            String excludedApps = Settings.System.getString(resolver,
                    Settings.System.BLACKLIST_APP_CIRCLE_BAR);
            if (mPackageAdapter != null) {
                mPackageAdapter.createExcludedAppsSet(excludedApps);
                mPackageAdapter.reloadApplications();
            }
        }
    }
