    ...
    class Configuration extends ContentObserver {
        ...
        private void updateSettings() {
            ...
            pocketMode = (Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.POCKET_MODE_ENABLE, 0, UserHandle.USER_CURRENT) == 1)
                    && (Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.ENABLE_ACTIVE_DISPLAY, 0, UserHandle.USER_CURRENT) == 0);

            showAlways = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.POCKET_MODE, 0, UserHandle.USER_CURRENT) == POCKET_MODE_ALWAYS;
