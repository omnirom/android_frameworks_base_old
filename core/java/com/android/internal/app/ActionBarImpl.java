...
public class ActionBarImpl extends ActionBar {
    ...
    public void changeColorFromActionBar() {
        ...
        int color = mActivity.getMainColorFromActionBarDrawable(drawable);

        if (textColor != -3) {
            iconTint = textColor;
        } else {
            if (mActivity.isBrightColor(color)) {
                iconTint = Color.BLACK;
            }
        }

        mActivity.sendAppColorBroadcast(color, iconTint);
    }
    ...
    public void hide() {
        ...
        mActivity.sendAppColorBroadcast(-3, -3);
    }
