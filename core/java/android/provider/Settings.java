...
public final class Settings {
    ...
    public static final class Secure extends NameValueTable {
        ...
        static {
            ...
            MOVED_TO_GLOBAL.add(Settings.Global.SMART_RADIO_START);
            MOVED_TO_GLOBAL.add(Settings.Global.SMART_RADIO_END);
        }
    ...
    public static final class Global extends NameValueTable {
       ...
       public static final String OVERLAY_DISPLAY_DEVICES = "overlay_display_devices";
         ...
         * @hide
         */
        public static final String SMART_RADIO_START =
                "smart_radio_start";

        /**
         * @hide
         */
        public static final String SMART_RADIO_END =
                "smart_radio_end";
