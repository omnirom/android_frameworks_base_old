...
i
    ...
    private void performKeyAction(int behavior) {
        Log.d(TAG, "performKeyAction " + behavior);
        switch (behavior) {
    ...
    private void updateKeyAssignments() {
        ...
        mPressOnBackBehavior = KEY_ACTION_MENU;
        ...
        if (keyRebindingEnabled) {
            if (hasHome) {
                ...
                Log.d(TAG, "home = " + mPressOnHomeBehavior + " home long = " + mLongPressOnHomeBehavior + " home double = " + mDoubleTapOnHomeBehavior);
            }
            if (hasMenu) {
                ...
                mLongPressOnMenuBehavior = Settings.System.getIntForUser(resolver,
                        ...
                        UserHandle.USER_CURRENT);
                Log.d(TAG, "menu = " + mPressOnMenuBehavior + " menu long = " + mLongPressOnMenuBehavior);
            ...
            if (hasBack) {
                ...
                mLongPressOnBackBehavior = Settings.System.getIntForUser(resolver,
                        ...
                        UserHandle.USER_CURRENT);
                Log.d(TAG, "back = " + mPressOnBackBehavior + " back long = " + mLongPressOnBackBehavior);
            }
            if (hasAssist) {
            ...
            if (down) {
                ...
                if (repeatCount == 0) {
                    if (mEnableShiftMenuBugReports && (metaState & chordBug) == chordBug) {
                        ...
                        Log.d(TAG, "Menu mMenuDoCustomAction = true");
                        mMenuDoCustomAction = true;
                        return -1;
                    }
                } else if (longPress) {
                    Log.d(TAG, "Menu longPress");
                    if (mRecentAppsPreloaded &&
                            mLongPressOnMenuBehavior != KEY_ACTION_APP_SWITCH) {
                        cancelPreloadRecentApps();
                    }
