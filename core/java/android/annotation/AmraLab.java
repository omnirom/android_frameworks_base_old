 ...
 * tested out in the Amra Lab prior to be a permanent feature.
 *
 * Example: @AmraLab(name="SomeSnazzyFeature", classification=Classification.NEW_CLASS)
 * @hide
 */
@Retention(RetentionPolicy.RUNTIME)
public @interface AmraLab
{
    /**
