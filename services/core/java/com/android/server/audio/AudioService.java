   ...
   /** Maximum volume index values for audio streams */
    ...
    private void initVolumeSteps() {
        ...
        MAX_STREAM_VOLUME[AudioSystem.STREAM_SYSTEM] =
                Settings.Global.getIntForUser(mContentResolver, "volume_steps_system",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_SYSTEM]);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_RING] =
                Settings.Global.getIntForUser(mContentResolver, "volume_steps_ring",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_RING]);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_MUSIC] =
                Settings.Global.getIntForUser(mContentResolver, "volume_steps_music",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_MUSIC]);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_ALARM] =
                Settings.Global.getIntForUser(mContentResolver, "volume_steps_alarm",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_ALARM]);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_NOTIFICATION] =
                Settings.Global.getIntForUser(mContentResolver, "volume_steps_notification",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_NOTIFICATION]);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_BLUETOOTH_SCO] =
                Settings.Global.getIntForUser(mContentResolver, "volume_steps_bluetooth_sco",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_BLUETOOTH_SCO]);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_SYSTEM_ENFORCED] =
                Settings.Global.getIntForUser(mContentResolver, "volume_steps_system_enforced",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_SYSTEM_ENFORCED]);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_DTMF] =
                Settings.Global.getIntForUser(mContentResolver, "volume_steps_dtmf",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_DTMF]);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_TTS] =
                Settings.Global.getIntForUser(mContentResolver, "volume_steps_tts",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_TTS]);
    }
