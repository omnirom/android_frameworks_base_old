        ...
        private int processPointerEvent(QueuedInputEvent q) {
            ...
            if (mGestureButtonEnabled && !mIsKeyguard) {
                if (event.getPointerCount() == 1) {
                    ...
                    switch (action) {
                        case 0:
                            Log.e(ViewRootImpl.TAG, "action 0");
                            ...
                            if (hit) {
                                Log.e(ViewRootImpl.TAG, "action 0 hit");
                        ...
                        case 3:
                            if (!mGestureButtonActive) {
                                Log.e(ViewRootImpl.TAG, "action 1 !mGestureButtonActive");
                                if (mCheckForGestureButton) {
                                    Log.e(ViewRootImpl.TAG, "action 1 mCheckForGestureButton");
                                    if (mHandler.hasMessages(ViewRootImpl.MSG_GESTURE_MOTION_DOWN)) {
                                        Log.e(ViewRootImpl.TAG, "action 1 removeMessages");
                                        mHandler.removeMessages(ViewRootImpl.MSG_GESTURE_MOTION_DOWN);
                                    }
                                    if (!mQueueMotionConsumed) {
                                        Log.e(ViewRootImpl.TAG, "action 1 !mQueueMotionConsumed");
                                        i2 = 0;
                        ...
                        case 2:
                            if (mCheckForGestureButton) {
                                Log.e(ViewRootImpl.TAG, "action 2");
                                mBackupEventList.add(MotionEvent.obtain(event));
                                ...
                                if (rotation == 0 || rotation == 2) {
                                    ...
                                    if (Math.abs(event.getRawY() - mRawY) > ((float) threshold)) {
                                        Log.e(ViewRootImpl.TAG, "action 2 reachDistance");
                                        reachDistance = true;
                                    }
                                ...
                                if (reachDistance) {
                                    ...
                                    Log.e(ViewRootImpl.TAG, "action 2 MSG_GESTURE_MOTION_DOWN");
                                    mHandler.removeMessages(ViewRootImpl.MSG_GESTURE_MOTION_DOWN);
                                    msg = Message.obtain(mHandler, ViewRootImpl.MSG_GESTURE_MOTION_DOWN, mView);
                                    mQueueMotionConsumed = false;
                                    mHandler.sendMessageDelayed(msg, (long) ViewRootImpl.GESTURE_MOTION_QUEUE_DELAY);
                                ...
                                Log.e(ViewRootImpl.TAG, "action 2 mGestureButtonActive");
                                return 1;
                            }
                            break;
