...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public boolean isCurrentRoundedSameAsFw() {
        ...
        int cornerRadius = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.OMNI_SYSUI_ROUNDED_SIZE, cornerRadiusRes);
        int contentPadding = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.OMNI_SYSUI_ROUNDED_CONTENT_PADDING, contentPaddingRes);
        ...
        if (sysuiRoundedFwvals && !isCurrentRoundedSameAsFw()) {
            ...
            if (res != null) {
                ...
                Settings.System.putInt(mContext.getContentResolver(),
                    Settings.System.OMNI_SYSUI_ROUNDED_SIZE, (int) (res.getDimension(resourceIdRadius) / density));
                int resourceIdPadding = res.getIdentifier("com.android.systemui:dimen/rounded_corner_content_padding", null, null);
                Settings.System.putInt(mContext.getContentResolver(),
                    Settings.System.OMNI_SYSUI_ROUNDED_CONTENT_PADDING, (int) (res.getDimension(resourceIdRadius) / density));
            }
        }
    }
