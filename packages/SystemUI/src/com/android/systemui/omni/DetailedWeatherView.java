...
public class DetailedWeatherView extends LinearLayout {
    ...
    private TextView mWeatherWindHumidity;
    ...
    protected void onFinishInflate() {
        ...
        mWeatherWindHumidity  = (TextView) findViewById(R.id.current_weather_wind_humidity);
    ...
    public void updateWeatherData(OmniJawsClient client, OmniJawsClient.WeatherInfo weatherData) {
        ...
        mWeatherWindHumidity.setText(weatherData.wind + " - " + weatherData.humidity);
