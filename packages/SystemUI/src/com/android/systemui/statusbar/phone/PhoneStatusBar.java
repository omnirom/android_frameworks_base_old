...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        mKeyguardShortcuts =
                (KeyguardShortcuts) mStatusBarWindow.findViewById(R.id.shortcut_container);
    ...
    private void updateKeyguardState(boolean goingToFullShade, boolean fromShadeLocked) {
        if (mState == StatusBarState.KEYGUARD) {
            final boolean showIndicator = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.LOCK_INDICATOR_DISPLAY, 1, mCurrentUserId) == 1;
            Log.d("maxwen", "showIndicator=" + showIndicator);
            mKeyguardIndicationController.setVisible(showIndicator);
            mKeyguardShortcuts.setVisible(true);
            mNotificationPanel.resetViews();
