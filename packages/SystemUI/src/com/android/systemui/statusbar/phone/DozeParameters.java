...
public class DozeParameters {
    ...
    public boolean getOverwriteValue() {
        final int values = Settings.System.getIntForUser(mResolver, Settings.System.DOZE_OVERWRITE_VALUE, 0,
                    UserHandle.USER_CURRENT);
        return values != 0;
    }

    public boolean getPocketMode() {
        final int values = Settings.System.getIntForUser(mResolver, Settings.System.DOZE_POCKET_MODE, 0,
                    UserHandle.USER_CURRENT);
        return values != 0;
    }
    ...
    public boolean getPulseOnNotifications() {
        if (getOverwriteValue()) {
            final int values = Settings.System.getIntForUser(mResolver,
