...
public class NavigationBarView extends FrameLayout implements
    ...
    private Region getButtonLocations(boolean includeFloatingButtons, boolean inScreenSpace,
        ...
        if (getPowerButton() != null) {
            updateButtonLocation(getPowerButton().getCurrentView(), inScreenSpace);
        }
        if (getVolumeMinusButton() != null) {
            updateButtonLocation(getVolumeMinusButton().getCurrentView(), inScreenSpace);
        }
        if (getVolumePlusButton() != null) {
            updateButtonLocation(getVolumePlusButton().getCurrentView(), inScreenSpace);
        }
        return mTmpRegion;
    }
