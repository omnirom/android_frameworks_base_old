...
public class CircleMemoryMeter extends ImageView {
    ...
    public CircleMemoryMeter(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPaintGreen.setColor(res.getColor(R.color.custom_green_translucent));
        mPaintOrange.setColor(res.getColor(R.color.holo_orange_light_translucent));
        mPaintRed.setColor(res.getColor(R.color.holo_red_light_translucent));
    ...
    private void init() {
        ...
        float levelStrokeWidth = strokeWidth / 1.5f; // needed for centering the text
        mPaintRed.setStrokeWidth(strokeWidth);
        mPaintGreen.setStrokeWidth(strokeWidth);
        mPaintOrange.setStrokeWidth(strokeWidth);
