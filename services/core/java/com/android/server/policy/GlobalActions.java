...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    private final class RebootAction extends SinglePressAction {
        ...
        private boolean dismissDialogEnabled() {
            boolean dismissDialogEnabled = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.GLOBAL_ACTION_DNAA, 0, UserHandle.USER_CURRENT) == 1;
                    ...
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Settings.System.putIntForUser(mContext.getContentResolver(),
                                Settings.System.GLOBAL_ACTION_DNAA, checkBoxResult ? 1 : 0,
