...
public class CommandQueue extends IStatusBar.Stub {
    ...
    private static final int MSG_TOGGLE_CAMERA_FLASH_PARAMS    = 39 << MSG_SHIFT;
    ...
    public interface Callbacks {
        ...
        default void toggleCameraFlashWithParams(int params) { }
    }
    ...
    public void toggleCameraFlashWithParams(int params) {
        synchronized (mLock) {
            mHandler.removeMessages(MSG_TOGGLE_CAMERA_FLASH_PARAMS);
            mHandler.obtainMessage(MSG_TOGGLE_CAMERA_FLASH_PARAMS, params).sendToTarget();
        }
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case MSG_TOGGLE_CAMERA_FLASH:
                    ...
                    break;
                case MSG_TOGGLE_CAMERA_FLASH_PARAMS:
                    for (int i = 0; i < mCallbacks.size(); i++) {
                        mCallbacks.get(i).toggleCameraFlashWithParams(msg.arg1);
                    }
                    break;
            }
        }
