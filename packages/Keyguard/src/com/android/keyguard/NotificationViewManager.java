...
public class NotificationViewManager {
    ...
    class Configuration extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_SHOW_NON_CLEARABLE), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
        ...
        private void updateSettings() {
            ...
            showNonClearable = Settings.System.getInt(mContext.getContentResolver(),
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_SHOW_NON_CLEARABLE, showNonClearable ? 1 : 0) == 1;
