...
public class DetailedWeatherView extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        mEmptyView = findViewById(R.id.empty_weather);
        ...
        mConditionLine.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                if (mWeatherClient.isOmniJawsEnabled()) {
                    startProgress();
    ...
    private void setErrorView() {
        ...
        mWeatherLine.setVisibility(View.INVISIBLE);
        mStatusMsg.setVisibility(View.VISIBLE);
        mProviderName.setVisibility(View.GONE);
    ...
    public void startProgress() {
        ...
        mConditionLine.setVisibility(View.GONE);
        mStatusLine.setVisibility(View.GONE);
    }
