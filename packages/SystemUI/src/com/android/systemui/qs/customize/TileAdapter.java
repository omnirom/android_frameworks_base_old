...
public class TileAdapter extends RecyclerView.Adapter<Holder> implements TileStateListener {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_SETTINGS) {
            ...
            Switch showLabels = settingsContainer.findViewById(R.id.qs_customize_settings_show_labels);
            showLabels.setChecked(mShowLabels);
            ...
            final SeekBar quickColumnsSlider = settingsContainer.findViewById(R.id.qs_customize_settings_quickbar);
            Switch quickFollow = settingsContainer.findViewById(R.id.qs_customize_settings_quickbar_follow);
            ...
            SeekBar columnsSliderPort = settingsContainer.findViewById(R.id.qs_customize_settings_columns_port);
            ...
            int columnsLand = Settings.System.getIntForUser(
                    ...
                    resourceColumns, UserHandle.USER_CURRENT);
            SeekBar columnsSliderLand = settingsContainer.findViewById(R.id.qs_customize_settings_columns_land);
