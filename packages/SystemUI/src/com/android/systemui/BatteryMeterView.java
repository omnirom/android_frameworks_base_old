...
public class BatteryMeterView extends View implements DemoMode {
    ...
    public BatteryMeterView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mFrameColor = res.getColor(R.color.batterymeter_frame_color);
    ...
    public void updateSettings(int defaultColor, int defaultBgColor) {
        mCurrentBgColor = defaultBgColor;
    ...
    public void updateSettings() {
        ...
        mActivated = (batteryStyle == 0 || batteryStyle == 2 || mShowPercent
    ...
    public void draw(Canvas c) {
        ...
        if (mCurrentBgColor != -3) {
            color = ColorUtils.opposeColor(mCurrentBgColor);
        } else {
            color = mFrameColor;
        }
        ...
        if (tracker.plugged) {
            // draw the bolt
            if (mCurrentColor != -3) {
                mBoltPaint.setColor((mCurrentColor == Color.WHITE) ? Color.BLACK : Color.WHITE);
            } else {
                mBoltPaint.setColor(mBoltColor);
            }
            ...
            if (mCurrentColor != -3) {
                textColor = (mCurrentColor == Color.WHITE) ? Color.BLACK : Color.WHITE;
            }
