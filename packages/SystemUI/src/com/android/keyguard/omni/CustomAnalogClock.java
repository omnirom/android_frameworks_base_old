...
public class CustomAnalogClock extends View {
    ...
    public CustomAnalogClock(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (mDial == null) {
            mDial = context.getDrawable(R.drawable.custom_clock_dial);
        }
        ...
        if (mHourHand == null) {
            mHourHand = context.getDrawable(R.drawable.custom_clock_hand_hour);
        }

        mMinuteHand = a.getDrawable(R.styleable.CustomAnalogClock_custom_hand_minute);
        if (mMinuteHand == null) {
            mMinuteHand = context.getDrawable(R.drawable.custom_clock_hand_minute);
        }
