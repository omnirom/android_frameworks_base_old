...
class QuickSettings {
    ...
    public static final String DEFAULT_TILES = Tile.USER + DELIMITER + Tile.BRIGHTNESS
        ...
        + DELIMITER + Tile.RSSI + DELIMITER + Tile.BLUETOOTH
        ...
        for (String tile : addMissing ? allTilesArray : storedTilesArray) {
            ...
            if (addTile) {
               if (Tile.USER.toString().equals(tile.toString())) { // User
                  ...
                  mModel.addWifiBackTile(wifiTile, new QuickSettingsModel.RefreshCallback() {
                        @Override
                  ...
                  if (mModel.deviceSupportsBluetooth()
                      ...
                      bluetoothTile.setCantMove(false);
                      ...
                      mModel.addBluetoothBackTile(bluetoothTile, new QuickSettingsModel.RefreshCallback() {
                            @Override
                            public void refreshView(QuickSettingsTileView unused, State state) {
                                BluetoothState bluetoothState = (BluetoothState) state;
