...
public class AudioService extends IAudioService.Stub {
    ...
    private static final int HEADSET_STOP_ACTION = 1;
    private static final int HEADSET_KILL_ACTION = 2;
    ...
    private class AudioServiceBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_DOCK_EVENT)) {
                ...
                int stopApp = Settings.System.getIntForUser(context.getContentResolver(),
                        Settings.System.HEADSET_PLUG_STOP_APP,0, UserHandle.USER_CURRENT);
                ...
                if(plugged == 1 && headsetPlugIntenatUri != null) {
                ...
                } else if (plugged == 0 && headsetPlugIntenatUri != null && stopApp != HEADSET_NONE_ACTION) {
                    ...
                    if (mKillAppName != null) {
                       if (stopApp == HEADSET_STOP_ACTION) {
                           PackageUtils.stopPackageProcess(mKillAppName, context);
                       } else if (stopApp == HEADSET_KILL_ACTION) {
