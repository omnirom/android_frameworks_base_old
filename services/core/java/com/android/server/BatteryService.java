...
public final class BatteryService extends SystemService {
    ...
    private void processValuesLocked(boolean force) {
        ...
        if (force || (mBatteryProps.batteryStatus != mLastBatteryStatus ||
            ...
            System.out.println("maxChargingWattage "+maxChargingWattage);
        }
    }
    ...
    private final class Led {
        ...
        private int Charge = maxChargingWattage*5;
        
        /*private void FastCharge() {
            if (fCharge > mFastThreshold){
                isFastCharging = true;
                }else{
        ...
        public Led(Context context, LightsManager lights) {
            ...
            System.out.println("my Charge = "+Charge+" Tresh = "+mFastThreshold);
        }
        ...
        public void updateLightsLocked() {
            ...
            //boolean fastlightEnabled = mFastChargingLedEnabled;
            ...
            if (!mLightEnabled) {
                ...
                lightEnabled = false;
            }else if(Charge > mFastThreshold){
                //Solid color when battery is fast charging
                System.out.println("is fast charging");
                lightColor = mFastBatteryARGB;
                lightEnabled = true;
            } else if (level < mLowBatteryWarningLevel) {
                if(Charge > mFastThreshold){
                    //Solid color when battery is fast charging
                    System.out.println("is fast charging");
                    lightColor = mFastBatteryARGB;
                    lightEnabled = true;
