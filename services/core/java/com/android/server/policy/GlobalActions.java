...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    private void buildMenuList() {
        ...
        for (int i = 0; i < mCurrentMenuActions.length; i++) {
            ...
            /*} else if (GLOBAL_ACTION_KEY_ASSIST.equals(actionKey)) {
                ...
                if (deviceSupportsCameraFlashlight(mContext) == true) {
    ...
    public static Drawable onTorchStateChanged() {
        if (mCameraManager.registerTorchCallback(mTorchCallback, mHandler) == 'disabled') {
            return R.com.android.internal.R.drawable.ic_global_torch_off;
        }
        else {
            return R.com.android.internal.R.drawable.ic_global_torch_on;
        }
    }
    ...
    private final class TorchAction extends SinglePressAction {
        private TorchAction() {
            super((onTorchStateChanged(), R.string.global_action_torch);
        }
