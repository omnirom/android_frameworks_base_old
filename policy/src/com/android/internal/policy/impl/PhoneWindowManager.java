...
import android.app.AmraBusyDialog;
...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    AmraBusyDialog mBootMsgDialog = null;
        ...
        mHandler.post(new Runnable() {
            @Override public void run() {
                if (mBootMsgDialog == null) {
                    mBootMsgDialog = new AmraBusyDialog(mContext, android.R.style.Theme_Translucent_NoTitleBar);
