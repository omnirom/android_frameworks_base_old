...
public class PackageParser {
    ...
    private static final String PROPERTY_FORCE_MAX_ASPECT_RATIO_ENABLED =
            "persist.sys.force_max_aspect_ration.enabled";

    private static final boolean MULTI_PACKAGE_APK_ENABLED = Build.IS_DEBUGGABLE &&
            SystemProperties.getBoolean(PROPERTY_CHILD_PACKAGES_ENABLED, false);

    private static final boolean FORCE_ASPECT_RATIO_ENABLED = SystemProperties.getBoolean(PROPERTY_FORCE_MAX_ASPECT_RATIO_ENABLED, false);
