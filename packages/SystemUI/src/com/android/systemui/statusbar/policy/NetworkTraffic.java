...
public class NetworkTraffic extends TextView {
    ...
    private void updateTrafficDrawable() {
        ...
        if (isSet(mState, MASK_UP + MASK_DOWN)) {
            intTrafficDrawable = R.drawable.network_traffic_updown;
        } else if (isSet(mState, MASK_UP)) {
            intTrafficDrawable = R.drawable.network_traffic_up;
        } else if (isSet(mState, MASK_DOWN)) {
            intTrafficDrawable = R.drawable.network_traffic_down;
        } else {
