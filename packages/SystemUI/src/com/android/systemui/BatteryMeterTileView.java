...
public class BatteryMeterTileView extends BatteryMeterView implements DemoMode {
    ...
    public void onDetachedFromWindow() {
        ...
        try {
            ...
            // Too bad
            // I'm sad
            // The receiver was already dead :(
        }
    }

    public BatteryMeterTileView(Context context) {
        this(context, null, 0);
    }

    public BatteryMeterTileView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BatteryMeterTileView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mHandler = new Handler();

        final Resources res = context.getResources();
        TypedArray levels = res.obtainTypedArray(R.array.batterymeter_color_levels);
        TypedArray colors = res.obtainTypedArray(R.array.batterymetertile_color_values);
        ...
        mChargeColor = getResources().getColor(R.color.batterymetertile_charge_color);
    ...
    protected class NormalBatteryMeterDrawable implements BatteryMeterDrawable {
        ...
        public NormalBatteryMeterDrawable(Resources res, boolean horizontal) {
            ...
            mFramePaint.setColor(res.getColor(R.color.batterymetertile_frame_color));
            ...
            mTextPaint.setColor(res.getColor(R.color.batterymetertile_bolt_color));
            ...
            mBoltPaint.setColor(res.getColor(R.color.batterymetertile_bolt_color));
    ...
    protected class CircleBatteryMeterDrawable implements BatteryMeterDrawable {
        ...
        public CircleBatteryMeterDrawable(Resources res) {
            ...
            mBackPaint.setColor(res.getColor(R.color.batterymetertile_frame_color));
    ...
    protected class TextBatteryMeterDrawable implements BatteryMeterDrawable {
        ...
        public void onDraw(Canvas c, BatteryTracker tracker) {
            ...
            if (unknownStatus) {
                ...
                Resources res = mContext.getResources();
                mFrontPaint.setColor(res.getColor(R.color.batterymetertile_frame_color));
                drawWithoutLevel(c, "?");
                return;
            }
