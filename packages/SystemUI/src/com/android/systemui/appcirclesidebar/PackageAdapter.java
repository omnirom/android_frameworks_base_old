...
public class PackageAdapter extends BaseAdapter implements InputItemHandler.InputHandleListener {
    ...
    public void reloadApplications() {
        ...
        for (ResolveInfo info : mApplications) {
            if (isExcludeApp(info.activityInfo.name)) {
    ...
    private boolean isExcludeApp(String packageName) {
        if (mExcludedApps != null) {
            return mExcludedApps.contains(packageName);
        }
        return false;
    }

    public void createExcludedAppsSet(String excludedApps) {
