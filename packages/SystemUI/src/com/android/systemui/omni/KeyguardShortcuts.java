...
public class KeyguardShortcuts extends FrameLayout {
    ...
    private int mShortcutItemMargin;
    ...
    protected void onFinishInflate() {
        ...
        mShortcutItemMargin = getResources().getDimensionPixelSize(
                R.dimen.keyguard_shortcut_item_margin);
        updateSettings();
    }
    ...
    private LinearLayout.LayoutParams getKeyguardAppParams() {
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                ...
                ViewGroup.LayoutParams.WRAP_CONTENT);
        params.setMargins(mShortcutItemMargin, 0, mShortcutItemMargin, 0);
        return params;
    }
