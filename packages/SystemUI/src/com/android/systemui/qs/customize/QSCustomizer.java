...
public class QSCustomizer extends LinearLayout implements OnMenuItemClickListener {
    ...
    public QSCustomizer(Context context, AttributeSet attrs) {
        ...
        int qsScrollValue = Settings.System.getIntForUser(mContext.getContentResolver(),
                Settings.System.QS_QUICKBAR_ALL, QuickQSPanel.NUM_QUICK_TILES_DEFAULT,
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_item_qs_scroll:
                ...
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.QS_QUICKBAR_ALL, item.isChecked() ?
                        99 : QuickQSPanel.NUM_QUICK_TILES_DEFAULT, UserHandle.USER_CURRENT);
                break;
            }
        return false;
    }
