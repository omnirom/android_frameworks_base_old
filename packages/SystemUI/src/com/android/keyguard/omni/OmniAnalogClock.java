...
public class OmniAnalogClock extends View {
    ...
    public OmniAnalogClock(Context context, AttributeSet attrs,
        ...
        mSecondsPaint.setColor(r.getColor(R.color.omni_clock_seconds_hand_color));
        ...
        mSecondsPaint.setStrokeWidth(r.getDimensionPixelSize(R.dimen.omni_clock_seconds_hand_width));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!mNoSeconds) {
            drawHand(canvas, mIsAmbientDisplay ? mAmbientPaint : mSecondsPaint, x, y, radius + mCircleStrokeWidth / 2, mSeconds / 60.0f * 360.0f - 90);
        }
    ...
    private final Runnable mClockTick = new Runnable () {
        ...
        public void run() {
            onTimeChanged();
            invalidate();
            OmniAnalogClock.this.postDelayed(mClockTick, 1000);
        }
    };
