...
public class BatterySaverService extends Service implements BluetoothConnectionChangeCallback,
    ...
    public void onMobileDataSignalChanged(
        ...
        /*if (!mSignalEvent) {
            ...
            mHandler.postDelayed(mEnabledAirPlaneMode, 300000);
        }*/
    }
    ...
    private void restoreAllState() {
        ...
        showToast(mobiledata, network, bluetooth, location, wifi, brightness, cpufreq);
    }
    ...
    private void showToast(boolean mobiledata, boolean network, boolean bluetooth,
                   boolean location, boolean wifi, boolean brightness, boolean cpufreq) {
        ...
        if (mobiledata) {
            ...
            what[2] = mResources.getString(R.string.battery_saver_bluetooth);
        } else if (location) {
            what[3] = mResources.getString(R.string.battery_saver_location);
        } else if (wifi) {
            what[4] = mResources.getString(R.string.battery_saver_wifi);
        } else if (brightness) {
            what[5] = mResources.getString(R.string.battery_saver_brightness);
        } else if (cpufreq) {
            what[6] = mResources.getString(R.string.battery_saver_cpu);
        } else if (mobiledata && network && bluetooth && location && wifi && brightness && cpufreq) {
            what[7] = mResources.getString(R.string.battery_saver_all);
        } else {
            what[8] = mResources.getString(R.string.battery_saver_no_changes);
        }
