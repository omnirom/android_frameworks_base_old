...
public class Activity extends ContextThemeWrapper
     ...
     * @hide
     */
    public void sendAppColorBroadcast(int st_color, int ic_color) {
        Intent colorIntent = new Intent(Intent.ACTION_ACTIONBAR_COLOR_DETECTOR);
        colorIntent.putExtra("packageactbar", (st_color != -3) ? true : false);
        colorIntent.putExtra("packagestcolor", st_color);
        colorIntent.putExtra("packageiccolor", ic_color);
    ...
    private void sendAppColorBroadcast() {
        ...
        colorIntent.putExtra("packagechnums", 1000);
        colorIntent.addFlags(
                Intent.FLAG_RECEIVER_REGISTERED_ONLY | Intent.FLAG_RECEIVER_FOREGROUND);
        sendBroadcastAsUser(colorIntent, UserHandle.CURRENT_OR_SELF);
    }
