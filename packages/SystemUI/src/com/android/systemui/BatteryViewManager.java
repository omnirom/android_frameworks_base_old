...
public class BatteryViewManager {
    ...
    public BatteryViewManager(Context context, LinearLayout mContainer, BarTransitions barTransitions,
        ...
        BatteryMeterPercentView bmv = (BatteryMeterPercentView) LayoutInflater.from(mContext).inflate(
                R.layout.battery_meter_percent_view, mContainerView, false);
        bmv.setShowBar(true);
        bmv.setShowPercent(true);
        mBatteryStyleList.add(bmv);

        BatteryMeterPercentView bmv1 = (BatteryMeterPercentView) LayoutInflater.from(mContext).inflate(
                R.layout.battery_meter_percent_view, mContainerView, false);
        bmv1.setShowBar(false);
        bmv1.setShowPercent(true);
        mBatteryStyleList.add(bmv1);

        BatteryMeterHorizontalView bmv2 = (BatteryMeterHorizontalView) LayoutInflater.from(mContext).inflate(
                R.layout.battery_meter_horizontal_view, mContainerView, false);
        bmv2.setShowPercent(false);
        mBatteryStyleList.add(bmv2);

        BatteryMeterHorizontalView bmv3 = (BatteryMeterHorizontalView) LayoutInflater.from(mContext).inflate(
                R.layout.battery_meter_horizontal_view, mContainerView, false);
        bmv3.setShowPercent(true);
        mBatteryStyleList.add(bmv3);

        BatteryCirclePercentView bmv4 = (BatteryCirclePercentView) LayoutInflater.from(mContext).inflate(
                R.layout.battery_circle_percent_view, mContainerView, false);
        bmv4.setShowPercent(false);
        mBatteryStyleList.add(bmv4);

        BatteryCirclePercentView bmv5 = (BatteryCirclePercentView) LayoutInflater.from(mContext).inflate(
                R.layout.battery_circle_percent_view, mContainerView, false);
        bmv5.setShowPercent(true);
        mBatteryStyleList.add(bmv5);
