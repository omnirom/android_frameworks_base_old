...
public class HorizontalBatteryMeterView extends View implements DemoMode {
    ...
    int mButtonHeight, mButtonWidth;
    ...
    public HorizontalBatteryMeterView(Context context) {
        this(context, null, 0);
    }

    public HorizontalBatteryMeterView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HorizontalBatteryMeterView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void draw(Canvas c) {
        ...
        mButtonWidth = (int) (width * 0.12f);
        mButtonHeight = (int) (width * 0.50f);

        mFrame.set(0, 0, width, height);
        mFrame.offset(pl, pt);

        mButtonFrame.set(
                mFrame.left + width - mButtonWidth - 5,
        ...
        if (tracker.plugged) {
            ...
            final int bt = (int)(mFrame.top + mFrame.height() / 10f);
            final int br = (int)(mFrame.right - mFrame.width() / 4.5f);
