...
class QuickSettingsFlipTile extends QuickSettingsTileView {
    ...
    void setCantMove(boolean move) {
         mFront.setCantMove(move);
         mFront.setOnTouchListener(null);
         mFront.setOnDragListener(null);
         mBack.setCantMove(move);
         mBack.setOnTouchListener(null);
         mBack.setOnDragListener(null);
    }
    ...
    void setTextPaddings(int pad) {
        mFront.setTextPaddings(pad);
        mBack.setTextPaddings(pad);
    }
