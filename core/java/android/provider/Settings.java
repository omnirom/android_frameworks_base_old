...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
         ...
         */
        public static final String DISABLED_PROXIMIT_SENSOR = "disable_proximity_sensor";

        /** @hide */
        public static final Validator DISABLED_PROXIMIT_SENSOR_VALIDATOR = sBooleanValidator;
        ...
        */
        ...
        static {
			...
			PUBLIC_SETTINGS.add(DISABLED_PROXIMIT_SENSOR);
        }
        ...
        static {
			...
			VALIDATORS.put(DISABLED_PROXIMIT_SENSOR, DISABLED_PROXIMIT_SENSOR_VALIDATOR);
