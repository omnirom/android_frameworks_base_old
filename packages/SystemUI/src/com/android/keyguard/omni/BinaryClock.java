...
public class BinaryClock extends View {
    ...
    public void onDensityOrFontScaleChanged() {
        Resources r = mContext.getResources();
        mDotSize = r.getDimension(R.dimen.binary_clock_dot_size);
        mDotPaint.setStrokeWidth(r.getDimensionPixelSize(R.dimen.binary_clock_stroke_size));
        mAmbientDotPaint.setStrokeWidth(r.getDimensionPixelSize(R.dimen.binary_clock_stroke_size));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int cellHeight = availableHeight / 5;
