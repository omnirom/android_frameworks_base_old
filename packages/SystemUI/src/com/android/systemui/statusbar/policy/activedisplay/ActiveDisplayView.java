...
public class ActiveDisplayView extends FrameLayout
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void update() {
            ...
            String privacyApps = Settings.System.getString(resolver,
            ...
            mUseActiveDisplayContent = Settings.System.getInt(
                    resolver, Settings.System.ACTIVE_DISPLAY_CONTENT, 1) != 0;
            mBypassActiveDisplay = Settings.System.getInt(
                    resolver, Settings.System.ACTIVE_DISPLAY_BYPASS, 1) != 0;
    ...
    private RemoteViews applyStandardTemplate(final Notification notification, final StatusBarNotification sbn) {
        ...
        if (nd.messageText != null) {
            if (isPrivacy) {
                ...
                contentView.setTextViewText(R.id.notificationtext, nd.messageText);
            }
        } else {
