...
public class KeyguardStatusView extends GridLayout {
    ...
    protected void onFinishInflate() {
        ...
        mVisibleInDoze = new View[]{mBatteryContainer, mClockView, mAnalogClockView, mDeadPoolClockView, mKeyguardStatusArea, mWeatherView};
    ...
    private void updateSettings() {
        ...
        switch (mClockSelection) {
            ...
            case 3: // analog (deadpool)
                mDeadPoolClockView.setVisibility(mShowClock ? View.VISIBLE : View.GONE);
                mAnalogClockView.setVisibility(View.GONE);
                mClockView.setVisibility(View.GONE);
