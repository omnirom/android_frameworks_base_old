...
public class InputMethodService extends AbstractInputMethodService {
        ...
        void observe() {
            getContentResolver().registerContentObserver(
                    Settings.System.getUriFor(Settings.System.ANIMATION_IME_DURATION),
                                    false, this, UserHandle.USER_CURRENT_OR_SELF);
            getContentResolver().registerContentObserver(
    ...
    private void updateSettings() {
        mAnimationEnterIndex = Settings.System.getIntForUser(getContentResolver(),
                      Settings.System.ANIMATION_IME_ENTER, 0, UserHandle.USER_CURRENT_OR_SELF);
        mAnimationExitIndex = Settings.System.getIntForUser(getContentResolver(),
                      Settings.System.ANIMATION_IME_EXIT, 0, UserHandle.USER_CURRENT_OR_SELF);
        mInterpolatorIndex = Settings.System.getIntForUser(getContentResolver(),
                      Settings.System.ANIMATION_IME_INTERPOLATOR, 0, UserHandle.USER_CURRENT_OR_SELF);
        int temp = Settings.System.getIntForUser(getContentResolver(),
                      Settings.System.ANIMATION_CONTROLS_DURATION, 500, UserHandle.USER_CURRENT_OR_SELF);
