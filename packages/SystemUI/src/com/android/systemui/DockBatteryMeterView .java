...
public class DockBatteryMeterView extends AbstractBatteryView {
    public static final String TAG = DockBatteryMeterView.class.getSimpleName();
    ...
    public DockBatteryMeterView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray atts = context.obtainStyledAttributes(attrs, R.styleable.DockBatteryMeterView,
                defStyle, 0);
        final int frameColor = atts.getColor(R.styleable.DockBatteryMeterView_frameColor,
    ...
    public void draw(Canvas c) {
        DockBatteryTracker tracker = mDemoMode ? mDemoTracker : mTracker;
        final int level = tracker.level;

        if (level == DockBatteryTracker.UNKNOWN_LEVEL) return;
