...
public class Constants {
    ...
    public static final int RECENT_CONTROL_TOP_RIGHT = 0;
    public static final int RECENT_CONTROL_TOP_LEFT = 1;
    public static final int RECENT_CONTROL_BUTTOM_RIGHT = 2;
    public static final int RECENT_CONTROL_BUTTOM_LEFT = 3;
}
