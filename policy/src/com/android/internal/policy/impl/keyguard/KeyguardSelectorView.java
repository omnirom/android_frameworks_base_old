...
public class KeyguardSelectorView extends LinearLayout implements KeyguardSecurityView {
	...
	Color mColor = new Color();
		...
		mCappedBattery = mBatteryLevel;
	    }
	    float mHue = (mCappedBattery - 15) * 1.6f;
            mGlowPadView.setArc(mBatteryLevel * 3.6f, mColor.HSVToColor(0x80,new float[]{ mHue, 1.f, 1.f }));
        }
    }
}
