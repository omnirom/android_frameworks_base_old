            ...
            val color =
                if (seedColor != null) {
                    ...
                    if (coloredClock)
                        ...
                        resources.getColor(org.omnirom.omniutlis.R.color.primary_text_material_dark)
                } else {
                    if (coloredClock)
                        resources.getColor(android.R.color.system_accent2_600)
                    else
                        resources.getColor(org.omnirom.omniutlis.R.color.primary_text_material_light)
                }
