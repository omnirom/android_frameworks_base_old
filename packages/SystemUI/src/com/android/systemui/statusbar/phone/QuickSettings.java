            ...
            if (addTile) {
               if (Tile.USER.toString().equals(tile.toString())) { // User
                  ...
                  if (mModel.deviceHasMobileData()) {
                      // RSSI
                      QuickSettingsBasicNetworkTile rssiTile = new QuickSettingsBasicNetworkTile(mContext);
                  ...
                  mModel.addBatteryTile(mBatteryTile, new QuickSettingsModel.RefreshCallback() {
                        ...
                        public void refreshView(QuickSettingsTileView unused, State state) {
                            ...
                            if (batteryState.batteryLevel == 100) {
                                mBatteryTile.setText(mContext.getString(R.string.quick_settings_battery_charged_label));
                            } else {
                                if (batteryState.pluggedIn) {
                                    mBatteryTile.setText(mBatteryStyle != 3 // circle percent
                                        ? mContext.getString(R.string.quick_settings_battery_charging_label,
                                        batteryState.batteryLevel)
                                        : mContext.getString(R.string.quick_settings_battery_charging));
                                } else {     // battery bar or battery circle
                                    mBatteryTile.setText((mBatteryStyle == 0 || mBatteryStyle == 2)
