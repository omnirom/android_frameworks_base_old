    ...
    class Configuration extends ContentObserver {
        ...
        private void updateSettings() {
            showAlways = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_SHOW_ALWAYS, showAlways ? 1 : 0, UserHandle.USER_CURRENT) == 1;
            pocketMode = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_POCKET_MODE, pocketMode ? 1 : 0, UserHandle.USER_CURRENT) == 1;
            hideLowPriority = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_HIDE_LOW_PRIORITY, hideLowPriority ? 1 : 0, UserHandle.USER_CURRENT) == 1;
            showNonClearable = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_SHOW_NON_CLEARABLE, showNonClearable ? 1 : 0, UserHandle.USER_CURRENT) == 1;
            dismissAll = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_DISMISS_ALL, dismissAll ? 1 : 0, UserHandle.USER_CURRENT) == 1;
            privacyMode = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_PRIVACY_MODE, privacyMode ? 1 : 0, UserHandle.USER_CURRENT) == 1;
            expandedView = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_EXPANDED_VIEW, expandedView ? 1 : 0, UserHandle.USER_CURRENT) == 1
                    && !privacyMode;
            forceExpandedView = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_FORCE_EXPANDED_VIEW, forceExpandedView ? 1 : 0, UserHandle.USER_CURRENT) == 1
                    && !privacyMode;
            wakeOnNotification = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_WAKE_ON_NOTIFICATION, wakeOnNotification ? 1 : 0, UserHandle.USER_CURRENT) == 1;
            notificationsHeight = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_HEIGHT, notificationsHeight, UserHandle.USER_CURRENT);
            offsetTop = Settings.System.getFloatForUser(mContext.getContentResolver(),
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_OFFSET_TOP, offsetTop, UserHandle.USER_CURRENT);
            ...
            notificationColor = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_COLOR, notificationColor, UserHandle.USER_CURRENT);
            dynamicWidth = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_DYNAMIC_WIDTH, dynamicWidth ? 1 : 0, UserHandle.USER_CURRENT) == 1;
