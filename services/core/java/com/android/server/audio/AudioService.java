   ...
   /** Maximum volume index values for audio streams */
    ...
    private void initVolumeSteps() {
        ...
        MAX_STREAM_VOLUME[AudioSystem.STREAM_VOICE_CALL] =
                Settings.System.getIntForUser(mContentResolver, "volume_steps_voice_call",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_VOICE_CALL], UserHandle.USER_CURRENT);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_SYSTEM] =
                Settings.System.getIntForUser(mContentResolver, "volume_steps_system",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_SYSTEM], UserHandle.USER_CURRENT);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_RING] =
                Settings.System.getIntForUser(mContentResolver, "volume_steps_ring",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_RING], UserHandle.USER_CURRENT);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_MUSIC] =
                Settings.System.getIntForUser(mContentResolver, "volume_steps_music",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_MUSIC], UserHandle.USER_CURRENT);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_ALARM] =
                Settings.System.getIntForUser(mContentResolver, "volume_steps_alarm",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_ALARM], UserHandle.USER_CURRENT);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_NOTIFICATION] =
                Settings.System.getIntForUser(mContentResolver, "volume_steps_notification",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_NOTIFICATION], UserHandle.USER_CURRENT);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_BLUETOOTH_SCO] =
                Settings.System.getIntForUser(mContentResolver, "volume_steps_bluetooth_sco",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_BLUETOOTH_SCO], UserHandle.USER_CURRENT);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_SYSTEM_ENFORCED] =
                Settings.System.getIntForUser(mContentResolver, "volume_steps_system_enforced",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_SYSTEM_ENFORCED], UserHandle.USER_CURRENT);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_DTMF] =
                Settings.System.getIntForUser(mContentResolver, "volume_steps_dtmf",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_DTMF], UserHandle.USER_CURRENT);

        MAX_STREAM_VOLUME[AudioSystem.STREAM_TTS] =
                Settings.System.getIntForUser(mContentResolver, "volume_steps_tts",
                        MAX_STREAM_VOLUME[AudioSystem.STREAM_TTS], UserHandle.USER_CURRENT);
    }
