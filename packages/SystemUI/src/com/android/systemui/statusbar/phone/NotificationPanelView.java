...
public class NotificationPanelView extends PanelView implements
    ...
    public void stopNotificationPulse() {
        ...
        if (mAmbientPulseLightRunning) {
            ...
            DozeParameters dozeParameters = DozeParameters.getInstance(mContext);
            if (DEBUG_PULSE_LIGHT) {
                Log.d(TAG, "stopNotificationPulse getAlwaysOn() = " + dozeParameters.getAlwaysOn() +
                        " getAlwaysOnAfterAmbientLight() = " + dozeParameters.getAlwaysOnAfterAmbientLight());
            }
            if (mDozing && !dozeParameters.getAlwaysOnAfterAmbientLight()) {
                if (DEBUG_PULSE_LIGHT) {
