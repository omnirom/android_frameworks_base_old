...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    private static final String GLOBAL_ACTION_KEY_SCREENCAPTURE = "screencapture";
    ...
    // Screenshot and Screencapture for Power Menu
    private final class ScreenShotAction extends SinglePressAction {
        private ScreenShotAction() {
            super(com.android.internal.R.drawable.ic_menu_gallery, R.string.global_action_reboot_recovery);
        }
    ...
    private final class ScreenCaptureAction extends SinglePressAction {
        private ScreenCaptureAction() {
            super(com.android.internal.R.drawable.ic_menu_camera, R.string.global_action_reboot_recovery);
        }
