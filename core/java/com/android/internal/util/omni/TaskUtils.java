...
public class TaskUtils {
    ...
    public static boolean killActiveTask(Context context) {
        try {
            return killActiveTaskInternal(context);
        } catch (RemoteException e) {
        }
        return false;
    }

    private static boolean killActiveTaskInternal(Context context)
             throws RemoteException {
        try {
             String defaultHomePackage = resolveCurrentLauncherPackage(context);
    ...
    public static void toggleLastApp(Context context, int userId) {
        try {
             toggleLastAppInternal(context, userId);
        } catch (RemoteException e) {
        }
    }

    private static void toggleLastAppInternal(Context context, int userId)
              throws RemoteException {
