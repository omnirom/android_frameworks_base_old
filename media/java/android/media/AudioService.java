    ...
    private class AudioServiceBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_DOCK_EVENT)) {
                ...
                boolean musicActive = Settings.System.getIntForUser(context.getContentResolver(),
                        Settings.System.HEADSET_PLUG_MUSIC_ACTIVE, 0, UserHandle.USER_CURRENT) == 1;

                Intent headsetPlugIntent = null;

                if (plugged == 1 && headsetPlugIntenatUri != null &&
                        (!musicActive || !isLocalOrRemoteMusicActive())) {
