...
public class KeyguardStatusBarView extends RelativeLayout
        implements BatteryController.BatteryStateChangeCallback, BatteryViewManager.BatteryViewManagerObserver {
    ...
    private void updateVisibilities() {
        ...
        mBatteryLevel.setVisibility((mBatteryCharging && mShowBatteryLevel) ? View.VISIBLE : View.GONE);
    }
