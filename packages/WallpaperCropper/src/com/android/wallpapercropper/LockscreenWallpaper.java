        ...
        actionBar.getCustomView().setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // Backup blur setting
                        int seeThrough = Settings.System.getIntForUser(mContext.getContentResolver(),
                                Settings.System.LOCKSCREEN_SEE_THROUGH, 0, UserHandle.USER_CURRENT);
                        Settings.System.putIntForUser(mContext.getContentResolver(),
                                Settings.System.LOCKSCREEN_SEE_THROUGH_BACKUP, seeThrough, UserHandle.USER_CURRENT);
                        // Disable blur
                        Settings.System.putIntForUser(mContext.getContentResolver(),
                                Settings.System.LOCKSCREEN_SEE_THROUGH, 0, UserHandle.USER_CURRENT);
        ...
        reset.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        int seeThrough = Settings.System.getIntForUser(mContext.getContentResolver(),
                                Settings.System.LOCKSCREEN_SEE_THROUGH_BACKUP, 0, UserHandle.USER_CURRENT);
                        Settings.System.putIntForUser(mContext.getContentResolver(),
                                Settings.System.LOCKSCREEN_SEE_THROUGH, seeThrough, UserHandle.USER_CURRENT);
                        reset();
