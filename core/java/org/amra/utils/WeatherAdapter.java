...
public class WeatherAdapter extends BroadcastReceiver {
	public static final String WEATHER_ACTION = "org.regulus.amraweather.amra_weather_state";
	public static final String WEATHER_SERVICE_STATE = "amra_weather_service_state";
