...
public class ActiveDisplayHost extends FrameLayout {
    ...
    public void updateCustomBackground(int show) {
        boolean isBlur = (show == 2);
        Bitmap bmp = getBitmapForBackground(isBlur);
        if ((bmp != null) && (show != 0)) {
    ...
    private Bitmap getBitmapForBackground(boolean isBlur) {
        Bitmap mBackground;
        try {
