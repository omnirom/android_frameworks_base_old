...
public final class BatteryService extends SystemService {
    ...
    private final class Led {
        ...
        public void updateLightsLocked() {
            ...
            boolean fastlightenabled = mFastBatteryLightEnabled & mIsFastCharging & mFastChargingLedSupported;
   ...
   private final class SettingsObserver extends ContentObserver {
        ...
        public void update() {
            ...
            mFastBatteryLightEnabled = Settings.System.getIntForUser(resolver,
                    Settings.System.FAST_CHARGING_LED_ENABLED, mFastBatteryLightEnabled ? 1 : 0, UserHandle.USER_CURRENT) != 0;
