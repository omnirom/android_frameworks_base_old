...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode {
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        mCenterClock = (ClockCenter) mStatusBarView.findViewById(R.id.center_clock);
    ...
    public void showClock(boolean show) {
        ...
        if (clockLocation == 0 && clock != null) {
            mClock.updateVisibilityFromStatusBar(show ? (showClock ? true : false) : false);
        }
        if (clockLocation == 1 && cclock != null) {
            mCenterClock.updateVisibilityFromStatusBar(show ? (showClock ? true : false) : false);
        }
    }
