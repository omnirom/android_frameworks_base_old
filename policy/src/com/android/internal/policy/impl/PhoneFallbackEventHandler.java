    ...
    boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_VOLUME_MUTE: {
                if (Settings.System.getInt(mContext.getContentResolver(), Settings.System.VOLUME_ROCKER_RINGTONE_CHANGE_ENABLED, 1) == 1) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_VOLUME_MUTE: {
                if (!event.isCanceled()) {
                    ...
                    if (audioManager != null && (Settings.System.getInt(mContext.getContentResolver(), Settings.System.VOLUME_ROCKER_RINGTONE_CHANGE_ENABLED, 1) == 1)) {
