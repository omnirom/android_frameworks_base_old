...
public interface StatusBarIconController {
     ...
     */
    class IconManager implements DemoModeCommandReceiver, OmniSettingsService.OmniSettingsObserver {
        ...
        protected StatusIconDisplayable addMobileIcon(
            ...
            Dependency.get(OmniSettingsService.class).addIntObserver(this, OmniSettings.OMNI_USE_OLD_MOBILETYPE);
            Dependency.get(OmniSettingsService.class).addIntObserver(this, OmniSettings.OMNI_HIDE_ROAMING_ICON);
        ...
        public void onIntSettingChanged(String key, Integer newValue) {
            for (int i = 0; i < mGroup.getChildCount(); i++) {
                ...
                if (child instanceof StatusBarMobileView) {
                    if (key.equals(OmniSettings.OMNI_USE_OLD_MOBILETYPE)) {
                        ((StatusBarMobileView) child).updateDisplayType(newValue == 1);
                    } else if (key.equals(OmniSettings.OMNI_HIDE_ROAMING_ICON)) {
