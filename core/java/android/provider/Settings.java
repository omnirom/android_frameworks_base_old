...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
         ...
         * @hide
         */
        public static final String FAST_BATTERY_LIGHT_LOW_COLOR = "fast_battery_light_low_color";

        /**
         * What color to use for the battery LED while charging - medium
         * @hide
         */
        public static final String FAST_BATTERY_LIGHT_MEDIUM_COLOR = "fast_battery_light_medium_color";

        /**
         * What color to use for the battery LED while charging - full
         * @hide
         */
        public static final String FAST_BATTERY_LIGHT_FULL_COLOR = "fast_battery_light_full_color";

        /**
         * What color to use for the battery LED while charging - really full (100%)
         * @hide
         */
        public static final String FAST_BATTERY_LIGHT_REALLY_FULL_COLOR = "fast_battery_light_really_full_color";
