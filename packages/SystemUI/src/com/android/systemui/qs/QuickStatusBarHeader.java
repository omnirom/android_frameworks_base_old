...
public class QuickStatusBarHeader extends FrameLayout implements
    ...
    public static final String QS_SHOW_TOP_SPACE = "qs_show_top_space";
    ...
    protected void onAttachedToWindow() {
        ...
        Dependency.get(TunerService.class).addTunable(this, QS_SHOW_TOP_SPACE);
    }
    ...
    public void onTuningChanged(String key, String newValue) {
        ...
        if (QS_SHOW_TOP_SPACE.equals(key)) {
            setVisibility(newValue == null || Integer.parseInt(newValue) != 0
                    ? VISIBLE : GONE);
        }
    }
}
