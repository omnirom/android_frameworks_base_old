        ...
        try {
            ...
            if (mShowNavBar) {
                if (mEnableTabletNavigation) {
                    ...
                    Log.v(TAG, "Showing Tablet Layout navigation");
                } else {
                    mNavigationBarView =
                        (NavigationBarView) View.inflate(context, R.layout.navigation_bar, null);
                    Log.v(TAG, "Showing Normal Layout navigation");
                }
        ...
        if (mShowNavBar) {
            if (mNavigationBarView == null) {
                if (mEnableTabletNavigation) {
                    ...
                    Log.v(TAG, "Showing Tablet Layout navigationbar");
                } else {
                    mNavigationBarView =
                        (NavigationBarView) View.inflate(mContext, R.layout.navigation_bar, null);
                    Log.v(TAG, "Showing normal Layout navigationbar");
                }
