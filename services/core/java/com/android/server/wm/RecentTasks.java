...
class RecentTasks {
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            mDisableVisibleLimits = Settings.System.getInt(mService.mContext.getContentResolver(),
                    Settings.System.OMNI_RECENT_TASKS_VISIBLE_DISABLE, 0) != 0;
        }
    }
    ...
    void loadRecentsComponent(Resources res) {
        ...
        mService.mContext.getContentResolver().registerContentObserver(
                Settings.Global.getUriFor(Settings.System.OMNI_RECENT_TASKS_VISIBLE_DISABLE),
