...
public class VolumePanel extends Handler {
    ...
    public VolumePanel(Context context, ZenModeController zenController) {
        ...
        mExpandPanel = (ImageView) mView.findViewById(com.android.systemui.R.id.further_options);
        mExpandPanel.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mSliderPanelExpand.setGravity(mExtendedPanelExpanded ? Gravity.BOTTOM : Gravity.TOP);
    ...
    private void updateZenPanelVisible() {
        ...
        setZenPanelVisible(mZenModeAvailable && mVoiceCapable /*&& isNotificationOrRing(mActiveStreamType)*/);
    }
