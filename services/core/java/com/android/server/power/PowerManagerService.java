...
public final class PowerManagerService extends SystemService
    ...
    private void updateSettingsLocked() {
        ...
        final boolean dozeOnChargeEnabledNow = Settings.System.getIntForUser(resolver,
                Settings.System.OMNI_DOZE_ON_CHARGE_NOW, 0, UserHandle.USER_CURRENT) != 0;
        Slog.d(TAG, "mAlwaysOnEnabled = " + mAlwaysOnEnabled + " mDozeOnChargeEnabled = " + mDozeOnChargeEnabled + " dozeOnChargeEnabledNow = " + dozeOnChargeEnabledNow);
