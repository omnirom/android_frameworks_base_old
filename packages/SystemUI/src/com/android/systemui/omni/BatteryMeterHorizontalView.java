...
public class BatteryMeterHorizontalView extends AbstractBatteryView {
    ...
    public void loadDimens() {
        ...
        mBarWidth = getResources().getDimensionPixelSize(com.android.settingslib.R.dimen.battery_height);
        mBarHeight = getResources().getDimensionPixelSize(com.android.settingslib.R.dimen.battery_width);
