...
class QuickSettingsModel implements BluetoothStateChangeCallback,
    ...
    private void onImmersiveFrontChanged() {
        ...
        if (mode == IMMERSIVE_MODE_OFF) {
            mImmersiveFrontState.iconId = R.drawable.ic_qs_immersive_global_off;
            mImmersiveFrontState.label = r.getString(R.string.quick_settings_immersive_global_off_label);
        } else {
            mImmersiveFrontState.iconId = R.drawable.ic_qs_immersive_global_on;
    ...
    private void onImmersiveBackChanged() {
        ...
        final int mode = getImmersiveMode();
        if (mode == IMMERSIVE_MODE_OFF) {
            mImmersiveBackState.iconId = R.drawable.ic_qs_immersive_off;
            mImmersiveBackState.label = r.getString(R.string.quick_settings_immersive_mode_off_label);
        } else if (mode == IMMERSIVE_MODE_FULL) {
            mImmersiveBackState.iconId = R.drawable.ic_qs_immersive_full;
            mImmersiveBackState.label = r.getString(R.string.quick_settings_immersive_mode_full_label);
        } else if (mode == IMMERSIVE_MODE_HIDE_ONLY_NAVBAR) {
            mImmersiveBackState.iconId = R.drawable.ic_qs_immersive_status_bar_off;
            mImmersiveBackState.label = r.getString(R.string.quick_settings_immersive_mode_no_status_bar_label);
        } else if (mode == IMMERSIVE_MODE_HIDE_ONLY_STATUSBAR) {
            mImmersiveBackState.iconId = R.drawable.ic_qs_immersive_navigation_bar_off;
            mImmersiveBackState.label = r.getString(R.string.quick_settings_immersive_mode_no_navigation_bar_label);
        }
