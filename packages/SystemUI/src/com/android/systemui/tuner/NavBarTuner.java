...
public class NavBarTuner extends TunerPreferenceFragment implements TunerService.Tunable {
    private static final String TAG = "NavBarTuner";
    ...
    private static CharSequence getLabel(String button, Context context) {
        if (button.startsWith(HOME)) {
            ...
            return context.getString(R.string.accessibility_recent);
                ...
                button.startsWith(LEFT) ||
                button.startsWith(RIGHT)) {
    ...
    private class NavBarAdapter extends RecyclerView.Adapter<Holder>
        ...
        private void bindButton(final Holder holder, int position) {
            ...
            if (mLabels.get(position).equals(context.getString(R.string.space))) {
                holder.itemView.findViewById(R.id.width).setVisibility(View.VISIBLE);
                bindClick(holder.itemView.findViewById(R.id.width), holder);
            } else {
                holder.itemView.findViewById(R.id.width).setVisibility(View.INVISIBLE);
            }
        ...
        private void showAddDialog(final Context context) {
            final String[] options = new String[] {
                    BACK, HOME, RECENT, MENU_IME, NAVSPACE, KEY,
            };
