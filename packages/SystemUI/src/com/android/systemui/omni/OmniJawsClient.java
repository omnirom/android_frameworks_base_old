...
public class OmniJawsClient {
    ...
    private void updateSettings() {
        if (isOmniJawsServiceInstalled()) {
            // TODO
            final String iconPack = null; /*Settings.System.getStringForUser(mContext.getContentResolver(),
    ...
    public Bitmap drawableToBitmap(Drawable image) {
