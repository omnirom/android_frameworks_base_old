...
public class GlobalActionsDialog implements DialogInterface.OnDismissListener,
    ...
    protected void createActionItems() {
        ...
        if (tempActions.contains(shutdownAction) && tempActions.contains(restartAction)
            ...
            mOverflowItems.add(shutdownAction);
            mOverflowItems.add(restartAction);
        ...
        if (advancedRebootEnabled(mContext)) {
            ...
            if (tempActions.contains(rebootRecoveryAction)) {
                mOverflowItems.add(rebootRecoveryAction);
            }
            if (tempActions.contains(rebootBootloaderAction)) {
                mOverflowItems.add(rebootBootloaderAction);
            }
            if (tempActions.contains(rebootFastbootAction)) {
