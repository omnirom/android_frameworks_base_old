...
import com.android.internal.util.omni.ProximitySensorManager;

public class NotificationViewManager implements ShakeSensorManager.ShakeListener,
        ProximitySensorManager.ProximityListener {
    ...
    public boolean mPocketModeEnable = false;
    ...
    class Configuration extends ContentObserver {
        ...
        private void updateSettings() {
            ...
            mPocketModeEnable = hasPriority && (Settings.System.getIntForUser(resolver,
    ...
    private void enableProximitySensor() {
        if (mPocketModeEnable) {
            Log.i(TAG, "LN: enable ProximitySensor");
    ...
    private void disableProximitySensor() {
        if (mPocketModeEnable) {
            Log.i(TAG, "LN: disable ProximitySensor");
    ...
    public synchronized void onNear() {
        ...
        if (mIsScreenOn && mPocketModeEnable && mWakedByPocketMode) {
            mWakedByPocketMode = false;
            Log.i(TAG, "LN: sent to sleep by Pocketmode");
            turnScreenOff();
        }
    }
