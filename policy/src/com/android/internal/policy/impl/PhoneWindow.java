    ...
    protected boolean onKeyDown(int featureId, int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_VOLUME_MUTE: {
                ...
                // and they don't.
                if (!AudioManager.USE_DEFAULT_STREAM_TYPE.equals(mVolumeControlStreamType) || Settings.System.getInt(getContext(), Settings.System.VOLUME_ROCKER_RINGTONE_CHANGE_ENABLED, 1) == 1) {
