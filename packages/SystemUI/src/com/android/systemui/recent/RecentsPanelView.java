...
public class RecentsPanelView extends FrameLayout implements OnItemClickListener, RecentsCallback,
    ...
    private void showImpl(boolean show) {
        ...
        if (show) {
            ...
            boolean showClearAllButton = System.Settings.getInt(mContext.getContentResolver(), System.Settings.SHOW_CLEAR_RECENTS_BUTTON, 1) == 1;
            mClearRecents.setVisibility(noApps || !showClearAllButton ? View.GONE : View.VISIBLE);
