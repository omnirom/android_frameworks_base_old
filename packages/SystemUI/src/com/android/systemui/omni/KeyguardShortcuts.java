...
public class KeyguardShortcuts extends LinearLayout {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        Log.d("maxwen", "onConfigurationChanged");
        super.onConfigurationChanged(newConfig);
        mShortcutIconSize = getResources().getDimensionPixelSize(android.R.dimen.app_icon_size);
    ...
    private LinearLayout.LayoutParams getKeyguardAppParams() {
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                ...
                ViewGroup.LayoutParams.WRAP_CONTENT);
        params.setMargins(mShortcutItemMargin / 2, 0, mShortcutItemMargin / 2, 0);
        return params;
    }

    private void buildShortcuts() {
        mShortcutItems.removeAllViews();
        mShortcutItems.setPadding(mShortcutItemMargin / 2, 0, mShortcutItemMargin / 2, 0);
    ...
    public void toggleShortcuts(boolean visible) {
    ...
    private void calcHorizontalDivider() {
        ...
        Log.d("maxwen", "numColumns = " + numColumns + " getCurrentDisplayWidth()=" + getCurrentDisplayWidth() + " mShortcutIconSize=" +
 mShortcutIconSize + " mShortcutItemMargin=" +mShortcutItemMargin);
    }
