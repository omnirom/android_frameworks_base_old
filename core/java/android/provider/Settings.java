...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        */
        ...
        public static final String OMNI_AMBIENT_NOTIFICATION_LIGHT_ENABLED = "ambiant_notification_light_enabled";

        private static final Validator OMNI_AMBIENT_NOTIFICATION_LIGHT_ENABLED_VALIDATOR = BOOLEAN_VALIDATOR;

        public static final String OMNI_AMBIENT_NOTIFICATION_LIGHT = "ambiant_notification_light";

        private static final Validator OMNI_AMBIENT_NOTIFICATION_LIGHT_VALIDATOR =
                BOOLEAN_VALIDATOR;

        public static final String OMNI_AMBIENT_NOTIFICATION_LIGHT_ACTIVATED = "ambiant_notification_light_activated";
